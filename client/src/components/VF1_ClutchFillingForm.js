// src/components/forms/ClutchFillingVF1.js

import React, { useState } from "react";
import axios from "axios";

const ClutchFillingVF1 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://localhost:5000/api/vf1-clutch-filling",
        formData
      );
...
export default ClutchFillingVF1;
